...
class Day14 : Day
{
    ...
    public override string Part1(List<string> Lines)
    {
        ...
        return PrintSolution(Simulate(Lines, 10), "3406", "part 1");
    }
    public override string Part2(List<string> Lines)
    {

        return PrintSolution(Simulate(Lines, 40), "3941782230241", "part 2");
    }
    private long Simulate(List<string> Lines, int iterations)
    {
