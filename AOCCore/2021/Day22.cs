...
class Day22 : Day
{
    ...
    public override void Part1(List<string> Lines)
    {
      ...
      PrintSolution(currentAreas.Where(x => x.Counter % 2 == 0).Sum(x => x.area) - currentAreas.Where(x => x.Counter % 2 == 1).Sum(x => x.area), "527915", "part 1");
    }
    ...
    public override void Part2(List<string> Lines)
    {
      ...
      PrintSolution(currentAreas.Where(x => x.Counter % 2 == 0).Sum(x => x.area) - currentAreas.Where(x => x.Counter % 2 == 1).Sum(x => x.area), "1218645427221987", "part 2");
    }
